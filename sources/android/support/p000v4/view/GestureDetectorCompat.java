                ...
                case 6:
                    ...
                    for (int i2 = 0; i2 < count; i2++) {
                        if (i2 != upIndex) {
                            ...
                            if ((x1 * VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, id2)) + (y1 * VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, id2)) < BitmapDescriptorFactory.HUE_RED) {
