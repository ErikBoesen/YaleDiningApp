...
public class ViewPager extends ViewGroup {
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        int position;
        float widthFactor = BitmapDescriptorFactory.HUE_RED;
    ...
    public void populate(int newCurrentItem) {
        ...
        if (this.mAdapter != null && !this.mPopulatePending && getWindowToken() != null) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                lp.childIndex = i;
                if (!lp.isDecor && lp.widthFactor == BitmapDescriptorFactory.HUE_RED) {
    ...
    private boolean isGutterDrag(float x, float dx) {
        if ((x >= ((float) this.mGutterSize) || dx <= BitmapDescriptorFactory.HUE_RED) && (x <= ((float) (getWidth() - this.mGutterSize)) || dx >= BitmapDescriptorFactory.HUE_RED)) {
            return DEBUG;
        }
        return true;
    }
