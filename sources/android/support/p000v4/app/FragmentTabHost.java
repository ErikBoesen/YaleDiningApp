...
public class FragmentTabHost extends TabHost implements OnTabChangeListener {
    ...
    private void initFragmentTabHost(Context context, AttributeSet attrs) {
        ...
        if (findViewById(16908307) == null) {
            ...
            tw.setId(16908307);
            tw.setOrientation(0);
            ll.addView(tw, new LinearLayout.LayoutParams(-1, -2, BitmapDescriptorFactory.HUE_RED));
            FrameLayout fl = new FrameLayout(context);
            fl.setId(16908305);
            ll.addView(fl, new LinearLayout.LayoutParams(0, 0, BitmapDescriptorFactory.HUE_RED));
