...
public final class StorageUtils {
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.mkdirs()) {
            C0214L.m415w("Unable to create external cache directory", new Object[0]);
            return null;
        }
        try {
            ...
            C0214L.m414i("Can't create \".nomedia\" file in application external cache directory", new Object[0]);
            return appCacheDir;
        }
    }
}
