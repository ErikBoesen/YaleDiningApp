...
public final class ImageLoaderConfiguration {
    ...
    public static class Builder {
        ...
        /* access modifiers changed from: private */
        public CompressFormat imageCompressFormatForDiscCache = null;
        /* access modifiers changed from: private */
        ...
        public Builder discCacheExtraOptions(int maxImageWidthForDiscCache2, int maxImageHeightForDiscCache2, CompressFormat compressFormat, int compressQuality) {
        ...
        public Builder memoryCacheSize(int memoryCacheSize2) {
            ...
            if (this.memoryCache != null) {
                C0214L.m415w(WARNING_MEMORY_CACHE_ALREADY_SET, new Object[0]);
            }
        ...
        public Builder memoryCache(MemoryCacheAware<String, Bitmap> memoryCache2) {
            if (this.memoryCacheSize != 2097152) {
                C0214L.m415w(WARNING_OVERLAP_MEMORY_CACHE_SIZE, new Object[0]);
            }
        ...
        public Builder discCacheSize(int maxCacheSize) {
            ...
            if (this.discCache != null) {
                C0214L.m415w(WARNING_DISC_CACHE_ALREADY_SET, new Object[0]);
            }
            if (this.discCacheFileCount > 0) {
                C0214L.m415w(WARNING_OVERLAP_DISC_CACHE_FILE_COUNT, new Object[0]);
            }
        ...
        public Builder discCacheFileCount(int maxFileCount) {
            ...
            if (this.discCacheSize > 0) {
                C0214L.m415w(WARNING_OVERLAP_DISC_CACHE_SIZE, new Object[0]);
            }
        ...
        public Builder discCache(DiscCacheAware discCache2) {
            ...
            if (this.discCacheFileNameGenerator != null) {
                C0214L.m415w(WARNING_OVERLAP_DISC_CACHE_FILE_NAME_GENERATOR, new Object[0]);
            }
