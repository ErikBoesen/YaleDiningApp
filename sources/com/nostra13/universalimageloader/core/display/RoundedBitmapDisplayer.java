...
public class RoundedBitmapDisplayer implements BitmapDisplayer {
    ...
    public static Bitmap roundCorners(Bitmap bitmap, ImageView imageView, int roundPixels2) {
        ...
        switch (C02131.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
            case 1:
        ...
        try {
            ...
            C0214L.m413e(e, "Can't create bitmap with rounded corners. Not enough memory.", new Object[0]);
            return bitmap;
        }
    }
