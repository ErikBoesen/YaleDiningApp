...
public interface C0118j extends IInterface {

    /* renamed from: com.google.android.gms.internal.j$a */
    public static abstract class C0119a extends Binder implements C0118j {

        /* renamed from: com.google.android.gms.internal.j$a$a */
        private static class C0120a implements C0118j {
            ...
            public void onMapLongClick(LatLng latLng) throws RemoteException {
                ...
                try {
                    ...
                    this.f77a.transact(1, obtain, obtain2, 0);
        ...
        /* renamed from: z */
        public static C0118j m168z(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapLongClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0118j)) ? new C0120a(iBinder) : (C0118j) queryLocalInterface;
        }
