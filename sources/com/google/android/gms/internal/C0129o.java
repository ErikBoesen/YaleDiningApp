...
public interface C0129o extends IInterface {

    /* renamed from: com.google.android.gms.internal.o$a */
    public static abstract class C0130a extends Binder implements C0129o {

        /* renamed from: com.google.android.gms.internal.o$a$a */
        private static class C0131a implements C0129o {
        ...
        /* renamed from: v */
        public static C0129o m193v(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0129o)) ? new C0131a(iBinder) : (C0129o) queryLocalInterface;
        }
